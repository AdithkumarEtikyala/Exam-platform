...
const prompt = ai.definePrompt({
  ...
  output: {schema: GenerateExamQuestionsOutputSchema, format: 'json'},
  ...
  The output should be a JSON array of question objects. Do not include any other text or explanation in your response, only the valid JSON array.
