...
export function ExamEditor({ examId }: { examId: string }) {
  ...
  const onSubmit = async (data: ExamFormData) => {
    ...
    try {
      ...
      updateDocumentNonBlocking(examRef, data);
      toast({
        title: 'Exam Saved',
  ...
  const isQuestionSectionVisible = examType === 'mcq' || examType === 'long-answer';
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className='flex items-center gap-2'>
                {examType === 'mcq' && <GenerateQuestionsDialog onQuestionsGenerated={addGeneratedQuestions} />}
