...
import { Check, ChevronLeft, ChevronRight, Flag, Loader2, Monitor, MonitorOff, AlertTriangle, User as UserIcon, Mail, ShieldAlert } from 'lucide-react';
...
export function ExamInterface({ examId }: { examId: string }) {
  ...
  useEffect(() => {
    if (rosterData === undefined || isRosterLoading) {
      ...
      setHasAccess(false); // Roster entry doesn't exist
    } else {
